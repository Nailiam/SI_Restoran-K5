Public Class Pramusaji
    ...
    Sub TampilkanData()
        Call koneksiDB()
        DA = New OleDb.OleDbDataAdapter("select * from Pramusaji", Conn)
        DS = New DataSet
        DA.Fill(DS)
    ...
    Private Sub btn_sv_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_sv.Click
        ...
        Else
            Call koneksiDB()
            CMD = New OleDb.OleDbCommand(" select * from Pramusaji where Id_pramusaji='" & txt_id.Text & "'", Conn)
            DM = CMD.ExecuteReader
            DM.Read()
            If Not DM.HasRows Then
                Call koneksiDB()
                Dim simpan As String
                simpan = "insert into Pramusaji values ('" & txt_id.Text &
    ...
    Private Sub btn_edit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_edit.Click
        ...
        Else
            Call koneksiDB()
            CMD = New OleDb.OleDbCommand("update pramusaji set Nama_Pramusaji = '" &
    ...
    Private Sub btn_delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_delete.Click
        ...
        Else
            If MessageBox.Show(" Are you sure to delete this data?", "Konfirmasi", MessageBoxButtons.YesNoCancel) Then
                Call koneksiDB()
                CMD = New OleDb.OleDbCommand(" delete from pramusaji where ID_Pramusaji = '" & txt_id.Text & "'", Conn)
                DM = CMD.ExecuteReader
